...
void Unit::update_bar_visibility() {
	if(getSprite()->getScaleX()!=0 && getSprite()->getScaleY()!=0 && ( _bar_visible || _selected ) ) _bar->set_visible(true);
