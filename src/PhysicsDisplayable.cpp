...
PhysicsDisplayable::PhysicsDisplayable(PhysicsDisplayableType type, float x, float y, float rotation, const char * filename, Game * game, Layer * layer, b2Body * body): Displayable(game,CCPhysicsSprite::create(filename),layer), _type(type) {
	_physicsSprite = (CCPhysicsSprite *)(getSprite());
...
PhysicsDisplayable::PhysicsDisplayable(PhysicsDisplayableType type, Game * game, CCPhysicsSprite * physicsSprite, Layer * layer):Displayable(game,physicsSprite,layer), _physicsSprite(physicsSprite), _type(type) {
}
