...
Turret::Turret(float x, float y, float rotation, const char * filename,
				float x_relative, float y_relative, float missile_speed, int damage, float cooldown): Displayable(x,y,rotation,filename)
{
