...
Game::Game(): Scene()
{
	...
	_display_layer->get_unit_layer()->add_unit(new Unit(250,200,250,200,-90,5,5.0f,1.0f,"units/tank01.png", this, "tank",100,100,100,100,100,100,100,100, joueur1));
	_display_layer->get_unit_layer()->add_unit(new Unit(400,200,400,200,-90,5,5.0f,1.0f,"units/tank01.png", this, "tank",100,100,100,100,100,100,100,100, joueur1));
	_display_layer->get_unit_layer()->add_unit(new Unit(100,200,100,200,-90,5,5.0f,1.0f,"units/tank01.png", this, "tank",100,100,100,100,100,100,100,100, joueur2));
