...
Game::Game(): Scene(), _scroll_left_mouse(false), _scroll_right_mouse(false), _scroll_up_mouse(false), _scroll_down_mouse(false), _scroll_left_key(false), _scroll_right_key(false), _scroll_up_key(false), _scroll_down_key(false), _mouse_button_left_down(false), _key_left_alt(false), _key_right_alt(false), _selection_zone_enable(false), _mouse_x(0), _mouse_y(0), _old_x(0), _old_y(0), _mouse_initiate(false), _hud_item_mouse(NULL)
{
	...
	for(i=0;i<10;i++)
	{
		...
		_display_layer->get_unit_layer()->add_unit(x,y,x,y,-90,5,5.0f,1.0f,"units/model_tank_00.png", "tank",100,100,1.0,100,100,1.0,6.0,100, _player_list[0],200);
		_display_layer->get_unit_layer()->get_unit(_display_layer->get_unit_layer()->get_number_unit()-1)->add_turret(0,"units/turret_tank_00.png", this, _display_layer->get_missile_layer(), 0, 0,50.0,"missiles/01.png", 12, 1.3, 250.0,_display_layer->get_unit_layer()->get_unit(_display_layer->get_unit_layer()->get_number_unit()-1));
	}
	...
	for(i=0;i<10;i++)
	{
		...
		_display_layer->get_unit_layer()->add_unit(x,y,x,y,-90,5,5.0f,1.0f,"units/model_tank_01.png", "tank",100,100,5.0,100,100,5.0,6.0,100, _player_list[1],200);
		_display_layer->get_unit_layer()->get_unit(_display_layer->get_unit_layer()->get_number_unit()-1)->add_turret(0,"units/turret_tank_01.png", this, _display_layer->get_missile_layer(), 0, 0, 50.0,"missiles/02.png", 12, 1.3, 250.0,_display_layer->get_unit_layer()->get_unit(_display_layer->get_unit_layer()->get_number_unit()-1));
	}
	*/
